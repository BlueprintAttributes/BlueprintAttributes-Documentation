...
export default {
  ...
  docsRepositoryBase: 'https://github.com/BlueprintAttributes/BlueprintAttributesDocumentation',
  ...
  project: {
    link: 'https://www.unrealengine.com/marketplace/en-US/product/gameplay-blueprint-attributes',
    icon: (
      <>
        {/* Unreal Logo */}
        <svg width="24" height="24" viewBox="0 0 336 336">
          <path fill="currentColor" d="M264.11,191.3h0c-2.79,13.44-15.19,47.94-54.74,66.62l-15.88-17.86L166.69,267a98.9,98.9,0,0,1-78.22-40.12,38.53,38.53,0,0,0,8.76,1.65c4.39.08,9.14-1.53,9.14-8.9v-72.7a12,12,0,0,0-15.05-12C78.91,137.79,69,168.75,69,168.75a98.44,98.44,0,0,1,34.07-75.44,99.85,99.85,0,0,1,50.27-23.19c-13.55,7.72-21.16,20.31-21.16,30.87,0,17,10.24,14.94,13.27,12.44v98.12a15.6,15.6,0,0,0,2,3.45,14.49,14.49,0,0,0,11.85,6c10.25,0,23.55-11.7,23.55-11.7V129.88c0-8.08-6.09-17.84-12.19-21.19,0,0,11.29-2,20,4.67h0a74.63,74.63,0,0,1,5.21-5.73C216.2,87.68,235.35,82,251.3,79.16h0s-29,22.79-29,53.37c0,22.74.59,78.2.59,78.2C233.65,221.12,249.65,206.11,264.11,191.3Z" />
          <path fill="currentColor" stroke="currentColor" strokeWidth="8" d="M168,6.26A161.74,161.74,0,1,0,329.74,168,161.74,161.74,0,0,0,168,6.26Zm0,317A155.27,155.27,0,1,1,323.27,168,155.27,155.27,0,0,1,168,323.27Z" />
        </svg>
      </>
    )
  },
