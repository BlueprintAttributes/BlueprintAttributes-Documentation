...
<Zoom>![](./getting-started/AttributeSets_Clamping_Manual_01.png)</Zoom>

Same for `PreAttributeChange` function.

<Zoom>![](./getting-started/AttributeSets_Clamping_Manual_02.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_Clamping_Manual_03.png)</Zoom>
<Zoom>![](./getting-started/AttributeSets_Clamping_Manual_04.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_Clamping_Manual_05.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_Clamping_Manual_06.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_Clamping_Manual_07.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_InteractGameplayEffect_01.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_InteractGameplayEffect_02.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_InteractGameplayEffect_03.png)</Zoom>
...
| InValue         | float                       | Original value for the Gameplay Attribute, before PreAttributeChange event and actual modification happened |
| OutValue        | float                       | New value for the Gameplay Attribute, after PreAttributeChange event and modification happened |

##### PostAttributeBaseChange

<Zoom>![](./getting-started/AttributeSets_InteractGameplayEffect_04.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_InteractGameplayEffect_05.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_InteractGameplayEffect_06.png)</Zoom>
...
#### Related: struct FGBAAttributeSetExecutionData
...
<Tabs items={['Blueprint', 'Members', 'Header']}>
  <Tabs.Tab>
    <Zoom>![](./getting-started/AttributeSets_InteractGameplayEffect_07.png)</Zoom>
  </Tabs.Tab>
  <Tabs.Tab>
| Name              | Type                            | Description                                                               |
| :-----            | :----                           | :----                                                                     |
...
Additionnaly, `UGBAAttributeSetBlueprintBase` defines a few custom helper intended to be used when implementing the AttributeSet events / method described earlier.

#### GetAttributeValue()

<Zoom>![](./getting-started/AttributeSets_HelperMethods_01.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_HelperMethods_02.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_HelperMethods_03.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_HelperMethods_04.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_HelperMethods_08.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_HelperMethods_06.png)</Zoom>
...
<Zoom>![](./getting-started/AttributeSets_HelperMethods_07.png)</Zoom>
...
<Callout type="default">
You'll get an Error if we were unable to get backthe ActorInfo cached pointer, and result will be a default `FGameplayAbilityActorInfo` with none of its member properly populated.
</Callout>
