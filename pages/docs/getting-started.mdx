...
<details open="true" class="details-reset border rounded-2">
  ...
  <video src="/videos/AttributeSets_Clamping_Property_10.mp4" controls="controls" muted="muted" class="d-block rounded-bottom-2 border-top width-fit" style={{ maxHeight: "640px", minHeight: "200px"}}>
  </video>
</details>
